...
export const EventCard: React.FC<EventCardProps> = ({ event }) => {
  ...
  // If parsing fails or assumes current year for past dates, we might need smarter logic
  // For now, relying on isLive and basic check.
          ...
          <div className="relative h-48 overflow-hidden">
            ...
            <div className="absolute bottom-4 left-4 flex gap-2">
              {event.isLive ? (
                ...
                <span className="bg-gray-600/90 text-white text-[10px] font-bold px-2 py-1 rounded-lg shadow-lg flex items-center gap-1">
                  COMPLETED
                </span>
              ) : (
                <span className="bg-primary/90 text-black text-[10px] font-bold px-2 py-1 rounded-lg shadow-lg flex items-center gap-1">
                  UPCOMING
                </span>
              )}
