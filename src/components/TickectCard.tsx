...
export const TicketCard: React.FC<TicketCardProps> = ({ ticket }) => {
    ...
    return (
        <div className="relative w-full mx-auto filter drop-shadow-2xl transform transition-transform hover:scale-[1.01]">
            <div className="flex flex-col w-full rounded-3xl overflow-hidden relative">

                {/* Top Section - Main Info */}
                <div className={`relative flex-1 bg-gradient-to-br ${theme.gradient} p-5 text-white border-b-2 border-dashed border-white/20`}>
                    ...
                    {/* Branding Watermark */}
                    <div className="absolute bottom-2 left-1/2 -translate-x-1/2 text-[60px] font-bold text-white/5 pointer-events-none whitespace-nowrap leading-none">
                        TKTHIVE
                    </div>
                    ...
                    <div className="relative z-10 flex flex-col h-full justify-between gap-4">
                        <div>
                            ...
                            <h2 className="text-2xl font-black uppercase leading-tight mb-3 text-white drop-shadow-md line-clamp-2">
                                {ticket.eventTitle}
                            </h2>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-3">
                                <div className="space-y-0.5">
                                    ...
                                    <div className="text-sm font-bold">{ticket.eventDate.split(',')[0]}</div>
                                ...
                                <div className="space-y-0.5">
                                    ...
                                    <div className="text-sm font-bold">20:00</div>
                            ...
                            <div className="space-y-0.5">
                                ...
                                <div className="text-sm font-bold truncate w-full">{ticket.eventVenue}</div>
                            </div>
                        </div>
                        ...
                        <div className="pt-4 border-t border-white/10 flex justify-between items-end">
                            <div>
                                ...
                                <div className="text-lg font-bold">{ticket.attendees} <span className="text-xs font-normal text-white/60">Person(s)</span></div>
                            </div>
                            <div className="text-right">
                                <div className="text-white/60 text-[10px] uppercase tracking-wider font-bold mb-0.5">Paid</div>
                                <div className={`text-lg font-bold ${theme.accent}`}>{ticket.price}</div>
                            </div>
                        </div>
                    </div>

                    {/* Bottom Perforations */}
                    <div className="absolute -bottom-3 left-0 w-6 h-6 bg-dark rounded-full" />
                    <div className="absolute -bottom-3 right-0 w-6 h-6 bg-dark rounded-full" />
                </div>

                {/* Bottom Section - Stub (QR Code) */}
                <div className="relative w-full bg-white text-black p-5 flex flex-col items-center justify-between">
                    ...
                    <div className="my-4 flex-1 flex flex-col items-center justify-center w-full">
                    ...
                    {/* Top Perforations */}
                    <div className="absolute -top-3 left-0 w-6 h-6 bg-dark rounded-full" />
                    <div className="absolute -top-3 right-0 w-6 h-6 bg-dark rounded-full" />
                </div>
            </div>
        </div>
    );
